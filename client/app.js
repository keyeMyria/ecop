...
Ext.Loader.setConfig({
    ...
    paths: {
        'Ecop': 'http://' + window.location.hostname + ':8080/ecop/client/src',
        'Web.ux': 'http://' + window.location.hostname + ':8080/web/client/packages/local/web-ux/src',
        'Web': 'http://' + window.location.hostname + ':8080/web/client/packages/local/web-data/src'
    }
});
