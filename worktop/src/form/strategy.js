 ...
 * Based on package react-validatorjs-strategy
 *
 * @see https://github.com/DanFMoore/react-validatorjs-strategy/blob/master/lib/strategy.js
 */
...
export default {
  ...
  activateRule: function(schema, rule) {
    if (
      typeof schema.activeRules !== 'undefined' &&
